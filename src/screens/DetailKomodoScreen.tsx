...
const DetailAmsterdamScreen : React.FC = () => {
  ...
  return (
    <View style={styles.screen}>
      ...
      >
        <ImageBackground
          source={require('../../assets/image/komodo.jpg')}
        ...
        >
          ...
          <View style={styles.headerOverlay}>
            ...
            <Text style={styles.title}>Pulau Komodo</Text>
            <Text style={styles.subtitle}>
             Home to the legendary Komodo dragons, this island offers a unique blend of natural wonders — from pink-sand beaches and rolling green hills to pristine tropical waters perfect for exploration. </Text>
          </View>
        </ImageBackground>
      </Animated.View>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.sectionTitle}>Discover the Beauty of Pulau Komodo</Text>
        ...
        <View style={styles.reviewCard}>
          ...
          <Text style={styles.reviewBody}>
           amazing yahh, best experience in my life.
          </Text>
        </View>
        ...
        {/* REKOMENDASI */}
        <Text style={styles.sectionTitleSmall}>Recommendation in Pulau Komodo</Text>
