...
const DetailRajaAmpatScreen : React.FC = () => {
  ...
  return (
    <View style={styles.screen}>
      ...
      >
        <ImageBackground
          source={require('../../assets/image/rajaampat.jpg')}
        ...
        >
          ...
          <View style={styles.headerOverlay}>
            ...
            <Text style={styles.title}>Raja Ampat</Text>
            <Text style={styles.subtitle}>
             Located in West Papua, Raja Ampat is a world-renowned marine paradise. Its turquoise waters, countless small islands, and incredible underwater biodiversity make it one of the most beautiful diving destinations on Earth.
            </Text>
          </View>
        </ImageBackground>
      </Animated.View>
      ...
      <View style={styles.container}>
        <View style={styles.countryRow}>
          <View style={styles.flagCircle}>
            <Image source={require('../../assets/image/flag.png')} style={styles.flagImage} />
          </View>
          <Text style={styles.countryText}>Indonesia</Text>
        </View>

        <Text style={styles.sectionTitle}>Discover the Beauty of Raja Ampat</Text>

        <View style={styles.reviewCard}>
          <View style={styles.reviewHeader}>
            <Image source={require('../../assets/image/flag.png')} style={styles.avatar} />
            <Text style={styles.reviewer}>By Faishal</Text>
          </View>
        ...
        {/* REKOMENDASI */}
        <Text style={styles.sectionTitleSmall}>Recommendation in Venezia</Text>
...
export default DetailRajaAmpatScreen;